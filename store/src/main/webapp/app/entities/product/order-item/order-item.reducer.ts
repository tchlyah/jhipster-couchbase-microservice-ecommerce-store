...
const apiSearchUrl = 'services/product/api/_search/order-items';

// Actions

export const searchEntities = createAsyncThunk('orderItem/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
