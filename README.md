# JHipster Couchbase Microservice eCommerce Store
...
To build the final jar and optimize the jhipsterCouchbaseMicroserviceEcommerceStore application for production, run:
